  ...
  return (
    <div className="space-y-6">
      ...
      <section className={BRANDED_CARD_CLASS}>
        ...
        <h2 className="mt-1 text-lg font-semibold text-slate-950">Add Availability Window</h2>
        <form action={createSelfServiceAvailabilityWindowAction} className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <fieldset className={`${BRANDED_FORM_PANEL_CLASS} md:col-span-2`}>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Choose one or more days to create recurring weekly availability.
            </p>
      ...
      <section className={BRANDED_CARD_CLASS}>
        ...
        <h2 className="mt-1 text-lg font-semibold text-slate-950">Add Blackout</h2>
        <form action={createSelfServiceBlackoutAction} className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <fieldset className={`${BRANDED_FORM_PANEL_CLASS} md:col-span-2`}>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Optional. Choose weekdays to create separate blackout blocks across the selected date range.
            </p>
            <div className="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
              {WEEKDAYS.map(([value, label]) => (
                <label
        ...
        <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          {blackoutsByDay.length ? (
            ...
            <p className="rounded-2xl border border-dashed border-slate-200 bg-white p-4 text-sm text-slate-600 md:col-span-2 xl:col-span-3">
              No blocked days are currently hiding self-service booking slots.
            </p>
          )}
        </div>
      </section>
      ...
      <section className={BRANDED_CARD_CLASS}>
        ...
        <h2 className="mt-1 text-lg font-semibold text-slate-950">Active Blackouts</h2>
        <div className="mt-4 divide-y divide-[var(--brand-border)]">
