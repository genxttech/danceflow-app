...
export async function GET(_request: Request, { params }: { params: Promise<{ envelopeId: string }> }) {
  ...
  page.drawText("DanceFlow Sign", { x:54, y:730, size:14, font:bold, color:rgb(.35,.12,.45) }); page.drawText("Completion Certificate", { x:54, y:695, size:24, font:bold, color:rgb(.08,.08,.12) });
  ...
  page.drawText("Generated by DanceFlow Sign", { x:54, y:54, size:9, font:regular, color:rgb(.45,.45,.5) });
