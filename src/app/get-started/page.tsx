          ...
          <div className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-20">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-5 text-lg leading-8 text-slate-600">
                Your free account is ready. Now choose whether you want to explore
                studios and events, run a studio, or publish and manage events.
              </p>

              <div className="mt-8 rounded-2xl border border-violet-200 bg-violet-50 px-5 py-4 text-left sm:text-center">
                <p className="text-sm font-semibold uppercase tracking-[0.16em] text-violet-700">
                  One account, multiple ways to use DanceFlow
                </p>
                <p className="mt-2 text-sm leading-7 text-slate-600">
                  Dancers get a free discovery account. Studios and organizers can
                  continue into transparent pricing and trial options built for their business.
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 grid gap-6 lg:grid-cols-3">
              <section className="rounded-[32px] border border-orange-200 bg-white p-7 shadow-sm">
                ...
                <p className="mt-4 text-sm leading-7 text-slate-600">
                  Use DanceFlow as a dancer to discover studios and events, save
                  favorites, and keep track of your dance journey from one account.
                </p>
              ...
              <section className="rounded-[32px] border border-violet-200 bg-white p-7 shadow-sm">
                ...
                <p className="mt-4 text-sm leading-7 text-slate-600">
                  ...
                  the plan that fits your operations and growth goals.
                </p>
            ...
            <div className="mt-10 rounded-[32px] border border-slate-200 bg-white p-7 shadow-sm">
              <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
                <div>
                  ...
                  <h2 className="mt-3 text-2xl font-semibold tracking-tight text-slate-900">
                    DanceFlow serves the public and the business side of dance
                  </h2>
                  <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">
                    The free discovery account is for dancers and the public. Studio
                    and organizer accounts continue into business pricing so users only
                    see the features and costs that fit their path.
                  </p>
                </div>
