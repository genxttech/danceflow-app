  ...
  function flushList() {
    ...
    elements.push(
      <ul
        ...
        className="my-5 list-disc space-y-2 pl-6 text-slate-700"
      >
        {listItems.map((item) => (
...
export default async function KnowledgebaseArticlePage({ params }: PageProps) {
  ...
  const articleUrl = `https://www.idanceflow.com/knowledgebase/${article.slug}`;
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Home",
        item: "https://www.idanceflow.com",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Knowledgebase",
        item: "https://www.idanceflow.com/knowledgebase",
      },
      {
        "@type": "ListItem",
        position: 3,
