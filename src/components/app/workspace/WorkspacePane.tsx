  ...
  return (
    <div className={classNames("flex min-h-0 flex-col", className)}>
      {title || description || actions ? (
        <div className="flex flex-col gap-3 border-b border-[var(--brand-border)] px-4 py-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            {title ? (
              <h2 className="text-sm font-semibold leading-5 text-[var(--brand-text)]">{title}</h2>
            ) : null}
            {description ? (
