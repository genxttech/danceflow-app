// C:\Dev\studioapp\src\components\app\CopyCalendarFeedButton.tsx
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs leading-5 text-slate-500">
        Tip: Some calendar tools refresh subscribed calendars on their own
        schedule, so website updates may not appear instantly.
      </p>
    </div>
  );
}